...
export const dutiesSlice = createSlice({
    ...
    reducers: {
        ...
        changeCalendarDisplay: (state, action) => {
            ...
            //state.currentDate = new Date(state.currentDate.getFullYear(), state.currentDate.getMonth(), initialState.currentDate.getDate() - initialState.currentDate.getDay())
        },
...
export const {getDuties, getCurrentDate, changeCalendarDisplay, changeStatsDisplay, changeCustomDateDisplay} = dutiesSlice.actions
...
export const selectIsWeekDisplay = (state: RootState) => state.duties.weekDisplay
export const selectIsStatsDisplay = (state: RootState) => state.duties.statsDisplay
export const selectIsCustomDateActive = (state: RootState) => state.duties.customDateDisplay
